...
DISTRICT_WISE_URLS = {
    ...
    # "Chandigarh" removed (same map as Punjab, id=17)
    ...
    "Kerala & Lakshadweep": "https://mausam.imd.gov.in/imd_latest/contents/districtwise-warning_mc.php?id=4",
    ...
    # "Mizoram" and "Nagaland" temporarily removed due to technical issues
    ...
    # \"Puducherry\" temporarily removed (same map as Tamil Nadu, id=26)
    ...
    "Tamil Nadu & Puducherry": "https://mausam.imd.gov.in/imd_latest/contents/districtwise-warning_mc.php?id=26",
    ...
    # "Uttarakhand" temporarily removed due to technical issues
